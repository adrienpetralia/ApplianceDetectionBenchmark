...
In the following table, we summarize our benchmark evaluation for each appliance detection case.
...
### Ketter Detection Accuracy (F1-Macro score)
...
### Convector Detection Accuracy (F1-Macro score)
